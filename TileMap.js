...
export default class TileMap{
  constructor(tileSize){
    ...
    this.DLCornerWall.src = "./DLCornerWall.png"; 
    this.DRCornerWall = new Image()
    this.DRCornerWall.src = "./DRCornerWall.png"; 
    this.ULCornerWall = new Image()
    this.ULCornerWall.src = "./ULCornerWall.png"; 
    this.URCornerWall = new Image()
    this.URCornerWall.src = "./URCornerWall.png";
    this.DownWall = new Image();
    this.DownWall.src = "./DownWall.png";
    this.LeftWall = new Image();
    this.LeftWall.src = "./LeftWall.png";
    this.RightWall = new Image();
    this.RightWall.src = "./RightWall.png";
    this.UpWall = new Image();
    this.UpWall.src = "./UpWall.png";
    //MID MAP WALLS
    this.MidDLCornerWall = new Image();
    this.MidDLCornerWall.src = "./MidDLCornerWall.png";
    this.MidDRCornerWall = new Image();
    this.MidDRCornerWall.src = "./MidDRCornerWall.png";
    this.MidULCornerWall = new Image();
    this.MidULCornerWall.src = "./MidULCornerWall.png";
    this.MidURCornerWall = new Image();
    this.MidURCornerWall.src = "./MidURCornerWall.png";
    this.MidHWall = new Image();
    this.MidHWall.src = "./MidHWall.png";
    this.MidVWall = new Image();
    this.MidVWall.src = "./MidVWall.png";
    //FOOD PNG value = 0 ----
    this.Food = new Image();
    this.Food.src = "./Food.png";  
  }
/* POSITION VALUES
