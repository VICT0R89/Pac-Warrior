...
export default class PacWarrior {
  ...
  #loadPacWarriorImg(){
    ...
    PacWarriorOne.src = "./PacWarriorOne.png";

    const PacWarriorTwo = new Image();
    PacWarriorTwo.src = "./PacWarriorTwo.png";

    const PacWarriorThree = new Image();
    PacWarriorThree.src = "./PacWarriorThree.png";

    const PacWarriorFour = new Image();
    PacWarriorFour.src = "./PacWarriorTwo.png";
